...
const studyElements = [
  ...
  {
    id: 'spectacles',
    src: 'https://images.unsplash.com/photo-1574281358998-969f65551c6c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400',
    alt: 'A pair of spectacles on a book',
    className: 'absolute bottom-[20%] right-[15%] w-40 h-auto rotate-12 animate-[pulse_12s_ease-in-out_infinite]',
    width: 400,
    height: 267,
  },
  {
